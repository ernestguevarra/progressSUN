...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{report1_sentences <-}\StringTok{ }\NormalTok{progress_report_}\DecValTok{2011} \OperatorTok{%>%}\StringTok{ }\KeywordTok{unnest_tokens}\NormalTok{(sentence, text, }\DataTypeTok{token =} \StringTok{"sentences"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
